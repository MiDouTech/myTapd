...
class TicketSdkImpl {
  ...
  private openModal(myTickets = false, prefillDescription?: string, autoCaptured = false): void {
    ...
    panel.style.cssText = myTickets
      ...
      : 'width:780px;max-width:calc(100vw - 48px);max-height:calc(100vh - 20px);box-sizing:border-box;background:#fff;border-radius:16px;box-shadow:0 8px 24px rgba(0,0,0,.18);font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial,sans-serif;display:flex;flex-direction:column;overflow:hidden;'
    ...
    panel.innerHTML = myTickets
      ...
      : `<div style="display:flex;justify-content:space-between;align-items:center;padding:26px 36px 24px;border-bottom:1px solid #ebeef5;flex:0 0 auto;">
           <strong style="font-size:27px;line-height:1.2;color:#303133;">提交工单</strong>
           <div style="display:flex;align-items:center;gap:28px;">
             <button type="button" data-action="open-my-tickets" style="padding:0;border:none;background:transparent;color:${primary};font-size:18px;line-height:1.5;cursor:pointer;">我的工单</button>
         ...
         <div data-role="submit-scroll" style="flex:1 1 auto;min-height:0;overflow:auto;padding:30px 36px 34px;">
           ...
           <button type="button" data-action="pick-attachment" aria-label="上传附件" style="width:100%;height:210px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;box-sizing:border-box;border:1px dashed #dcdfe6;background:#fff;border-radius:10px;cursor:pointer;color:inherit;">
             ...
             <span style="font-size:19px;color:${primary};">上传附件</span>
