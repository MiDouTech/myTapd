    ...
    async renderTicketDetail(panel, ticketNo) {
      ...
      try {
        ...
        <div style="display:flex;flex-direction:column;gap:14px;">
          ...
          <div data-role="supplement-editor" style="display:none;border-top:1px solid #ebeef5;padding-top:12px;">
            ...
            <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:10px;">
              ...
              <button type="button" data-action="submit-supplement" style="padding:7px 12px;border:none;background:${((_b = (_a = this.config) == null ? void 0 : _a.theme) == null ? void 0 : _b.primaryColor) ?? "#1675d1"};color:#fff;border-radius:4px;cursor:pointer;">提交补充</button>
            </div>
          </div>
          <div data-role="ticket-actions" style="display:flex;flex-wrap:wrap;gap:8px;border-top:1px solid #ebeef5;padding-top:12px;">
            <button type="button" data-action="show-supplement" style="padding:8px 14px;border:none;background:${((_d = (_c = this.config) == null ? void 0 : _c.theme) == null ? void 0 : _d.primaryColor) ?? "#1675d1"};color:#fff;border-radius:4px;cursor:pointer;">补充信息</button>
        ...
        </div>`;
        {
          ...
          (_e = container.querySelector('[data-action="back-to-tickets"]')) == null ? void 0 : _e.addEventListener("click", () => {
            container.innerHTML = '<div data-role="list" style="min-height:120px;color:#606266;">加载中...</div>';
            void this.renderMyTickets(panel);
          });
          (_f = container.querySelector('[data-action="open-public-detail"]')) == null ? void 0 : _f.addEventListener("click", () => this.openPublicTicket(detail.ticketNo));
          (_g = container.querySelector('[data-action="show-supplement"]')) == null ? void 0 : _g.addEventListener("click", () => {
            ;
          ...
          (_h = container.querySelector('[data-action="cancel-supplement"]')) == null ? void 0 : _h.addEventListener("click", () => {
            ;
          ...
          (_i = container.querySelector('[data-action="pick-supplement-file"]')) == null ? void 0 : _i.addEventListener("click", () => supplementFilesEl.click());
          ...
          supplementContentEl.addEventListener("paste", (event) => {
            const imageFiles2 = this.extractClipboardImageFiles(event);
            if (!imageFiles2.length) return;
            event.preventDefault();
            void this.uploadSupplementFiles(panel, imageFiles2, supplementUploads);
          });
          (_j = container.querySelector('[data-action="submit-supplement"]')) == null ? void 0 : _j.addEventListener("click", () => {
            void this.submitTicketSupplement(panel, detail.ticketNo, supplementUploads);
          });
          (_k = container.querySelector('[data-action="urge-ticket"]')) == null ? void 0 : _k.addEventListener("click", () => {
