    ...
    <div data-role="mine-pagination" style="flex:0 0 auto;display:flex;align-items:center;justify-content:space-between;gap:12px;padding-top:14px;color:#667085;font-size:12px;"></div>`;
      ...
      const load = async () => {
        ...
        try {
          ...
          (_c = results.querySelector('[data-action="mine-retry"]')) == null ? void 0 : _c.addEventListener("click", () => void load());
        }
      };
      (_a = container.querySelector('[data-action="mine-search"]')) == null ? void 0 : _a.addEventListener("click", () => {
        pageNum = 1;
        void load();
      });
      (_b = container.querySelector('[data-action="mine-reset"]')) == null ? void 0 : _b.addEventListener("click", () => {
        titleInput.value = "";
