(function(global, factory) {
  ...
  class TicketSdkImpl {
      ...
      const load = async () => {
        ...
        try {
          ...
          if (!page.records.length) {
            ...
            results.querySelectorAll('[data-action="open-ticket-item"]').forEach((node) => node.addEventListener("click", () => void this.renderTicketDetail(panel, node.dataset.ticketNo ?? "")));
          }
    ...
    async createTicket(title, content, attachments) {
      var _a;
