  ...
  class TicketSdkImpl {
    ...
    openModal(myTickets = false, prefillDescription, autoCaptured = false) {
      ...
      if (myTickets) {
        ...
        attachmentDropzone == null ? void 0 : attachmentDropzone.addEventListener("paste", (event) => {
    ...
    async uploadAttachment(panel, descriptionEl, attachments, file) {
      const messageEl = panel.querySelector('[data-role="message"]');
    ...
    async uploadAttachmentFiles(panel, descriptionEl, attachments, files) {
      for (const file of files) {
    ...
    insertImageToEditor(editor, imageUrl) {
      if (!editor || !imageUrl) {
        return;
      }
      editor.focus();
