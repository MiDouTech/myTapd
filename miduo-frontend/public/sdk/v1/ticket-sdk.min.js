  ...
  class TicketSdkImpl {
    ...
    async renderMyTickets(panel) {
      ...
      try {
        ...
        listEl.innerHTML = page.records.map(
        ...
        listEl.querySelectorAll('[data-action="open-ticket-item"]').forEach((node) => {
          node.addEventListener("click", () => {
            const ticketNo = node.getAttribute("data-ticket-no") ?? "";
