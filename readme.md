...
6. 点击「刷新」，页面应重新拉取最新数据。
7. 点击类型筛选（如“新功能”“文档”），列表应只展示对应类型的更新。
...
1. 把 `changelogs/*.md` 汇总到 `CHANGELOG.md` 的新版本块；
...
- **记录（错误类型）**：不是报错，是防误操作保护（避免未提交内容被误清空）。  
- **恢复建议**：
